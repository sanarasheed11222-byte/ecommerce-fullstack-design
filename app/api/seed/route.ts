...
const products = [
  ...
  { name: 'Moisturizer', price: 1500, category: 'Beauty', stock: 45, description: 'Daily moisturizer.', image: 'https://images.unsplash.com/photo-1570194065650-d99fb4d8a609?w=400&auto=format&fit=crop&q=80' },
  { name: 'iPad', price: 120000, category: 'Electronics', stock: 8, description: 'Powerful iPad.', image: 'https://images.unsplash.com/photo-1544244015-0df4592c8e62?w=400&auto=format&fit=crop&q=80' },
  { name: 'Summer Dress', price: 5500, category: 'Fashion', stock: 12, description: 'Beautiful summer dress.', image: 'https://images.unsplash.com/photo-1502716119720-b23a93e5fe1b?w=400&auto=format&fit=crop&q=80' },
  ...
  { name: 'Non-stick Pan', price: 3200, category: 'Kitchen', stock: 20, description: 'Ceramic non-stick pan.', image: 'https://images.unsplash.com/photo-1584990347449-a2d4c2c044ba?w=400&auto=format&fit=crop&q=80' },
  { name: 'Tennis Racket', price: 4500, category: 'Sports', stock: 18, description: 'Carbon fiber racket.', image: 'https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=400&auto=format&fit=crop&q=80' },
  ...
  { name: 'Keyboard', price: 8500, category: 'Electronics', stock: 14, description: 'Mechanical keyboard.', image: 'https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=400&auto=format&fit=crop&q=80' },
  ...
  { name: 'Microwave', price: 18000, category: 'Kitchen', stock: 8, description: '30L microwave oven.', image: 'https://images.unsplash.com/photo-1574269909862-7e1d70bb8078?w=400&auto=format&fit=crop&q=80' },
  { name: 'Cycling Helmet', price: 3500, category: 'Sports', stock: 15, description: 'Aerodynamic helmet.', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&auto=format&fit=crop&q=80' },
  { name: 'Eye Shadow Kit', price: 2800, category: 'Beauty', stock: 25, description: '24 color eyeshadow.', image: 'https://images.unsplash.com/photo-1512207736890-6ffed8a84e8d?w=400&auto=format&fit=crop&q=80' },
